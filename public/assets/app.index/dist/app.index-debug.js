define("xhub/app.index/1.0.0/app.index-debug", [ "angular/angularjs/1.1.5/angular-debug", "angular/angularjs/1.1.5/angular-resource-debug", "angularjs-debug", "xhub/app/1.0.0/app-debug" ], function(require, exports, module) {
    "use strict";
    var angular = require("angular/angularjs/1.1.5/angular-debug");
    require("angular/angularjs/1.1.5/angular-resource-debug");
    var app = require("xhub/app/1.0.0/app-debug");
    // app index
    var index = angular.module("xhub.app.Index", [ "ngResource", "xhub.App" ]);
    index.config(app.fixHttp);
    // TODO
